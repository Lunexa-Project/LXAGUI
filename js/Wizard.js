...
function getApproximateBlockchainHeight(_date, _nettype){
    ...
    var lunexaBirthTime = _nettype == "Mainnet" ? 310 : _nettype == "Testnet" ? 1410295020 : 1518932025;
    // avg seconds per block in v1
    var secondsPerBlockV1 = 60;
    // time of v2 fork 2016-03-23 15:57:38 (1458748658)
    var forkTime = _nettype == "Mainnet" ? 310 : _nettype == "Testnet" ? 1448285909 : 1520937818;
    // v2 fork block
    var forkBlock = _nettype == "Mainnet" ? 310 : _nettype == "Testnet" ? 624634 : 32000;
    ...
    if (requestedTime < lunexaBirthTime){
        console.log("Calculated blockchain height: 0, requestedTime < lunexaBirthTime " );
        return 0;
    }
    // time between during v1
    if (requestedTime > lunexaBirthTime && requestedTime < forkTime){
        approxBlockchainHeight = Math.floor((requestedTime - lunexaBirthTime)/secondsPerBlockV1);
