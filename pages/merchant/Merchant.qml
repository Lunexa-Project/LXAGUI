        ...
        Item {
            ...
            Item {
                ...
                LunexaComponents.TextPlain {
                    ...
                    font.bold: false
                    color: "white"
                    text: "<style type='text/css'>a {text-decoration: none; color: #DBC1FF; font-size: 12px;}</style>%1: %2 <a href='#'>(%3)</a>"
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    LunexaComponents.TextPlain {
                        ...
                        font.bold: false
                        color: "white"
                        text: qsTr("Amount to receive") + " (LXA)" + translationManager.emptyString
                        themeTransition: false
                    }
                    ...
                    LunexaComponents.TextPlain {
                        // @TODO: When we have LXA/USD rate avi. in the future.
                        visible: false
                        font.pixelSize: 14
                        font.bold: false
                        color: "white"
